...
export const NewTurno = () => {
  ...
  return (
    <MainLayout>
      ...
      >
        {({ isSubmitting }) => (
          <Form className="p-4 mb-4 bg-white rounded shadow-md">
            <div className="">
              <label
              ...
              <Field
                type="date"
                name="dia"
                className="w-full p-2 leading-tight text-white border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
              />
              <ErrorMessage
                name="dia"
                component="div"
            ...
            <div className="mb-4">
              ...
              <Field
                type="text"
                name="mascota"
                className="px-3 py-2 leading-tight text-white border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
              />
              <ErrorMessage
                name="mascota"
                component="div"
